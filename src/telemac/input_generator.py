...
try:
    from telemac.modules.environment_setup import EnvironmentSetup
    from telemac.modules.parameter_manager import ParameterManager
...
def main(
    ...
    **kwargs,
    ...
    if pipeline:
        ...
        # Generate test set (10% of training sample size)
